...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "21 " + FormatFullVersion();
...
bool BindListenPort(const CService &addrBind, string& strError)
{
...
#ifdef SO_NOSIG21PE
    // Different way of disabling SIG21PE on BSD
    setsockopt(hListenSocket, SOL_SOCKET, SO_NOSIG21PE, (void*)&nOne, sizeof(int));
#endif
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. 21 is probably already running."), addrBind.ToString().c_str());
        else
