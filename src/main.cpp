...
// Copyright (c) 2013 21 developers
...
const string strMessageMagic = "21 Signed Message:\n";
...
static const int64 nTargetSpacing = 126; // 3.14 minutes
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    {
        printf("dropmessagestest DROP21NG RECV MESSAGE\n");
        return true;
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("21Miner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("21Miner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running 21Miner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
